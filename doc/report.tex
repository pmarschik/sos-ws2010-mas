...
%%%% Use Case Diagramm Placeholder
\img{1}{usecases.pdf}{Use Cases}{}

The use case diagram shows that two agent classes are needed: PrisonerAgent and GameMasterAgent.

The Agents require to communicate with eachother on several channels.
...
\img{1}{chart1_Part2.pdf}{State chart for prisoner}{}
\img{1}{chart1_Part3.pdf}{State chart for game-master}{}
\img{1.1}{chart1_Part1.pdf}{Sequence chart}{}
